		...
		<div class="container-fluid">
			...
			<form:form method="post" commandName="newPlace" action="create-place" cssClass="form-horizontal">
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="name" placeholder="Nombre del lugar" maxlength="255" cssClass="span8" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="type">Tipo de lugar</label>
					<div class="controls">
						<form:input path="type" placeholder="Restaurante, Monumento, Hospital" maxlength="255" cssClass="span8" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="locality">Localidad</label>
					<div class="controls">
						<form:input path="locality" placeholder="Localidad del lugar" maxlength="255" cssClass="span6" />
					</div>
				</div>
				<div class="control-group">
